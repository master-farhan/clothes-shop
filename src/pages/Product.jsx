      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <button
            ...
            className="bg-black text-white px-8 py-3 textsm active:bg-gray-700"
          >
            ADD TO CART
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border border-gray-300 p-6 text-sm text-gray-500">
          <p className="">
            ...
            consectetur voluptatum molestiae. Consectetur doloremque
            voluptatibus accusamus adipisci facilis amet, itaque architecto qui
            quasi dolore cupiditate vero, id possimus nulla!
          </p>
          <p className="">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eaque
            fugiat totam excepturi asperiores architecto culpa odio voluptate
            nihil voluptatibus sint id quae sunt, magni incidunt reiciendis
            ipsa? Saepe, expedita repellat.
          </p>
        </div>
      </div>
